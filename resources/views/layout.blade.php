                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{url('admin/category')}}">Todas</a>
                                    <a class="nav-link" href="{{url('admin/category/create')}}">Adicionar Nova</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="posts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{url('admin/post')}}">Ver Todos</a>
                                    <a class="nav-link" href="{{url('admin/post/create')}}">Adicionar Novo</a>
                                </nav>
                            </div>
